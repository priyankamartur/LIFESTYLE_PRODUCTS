...
export default function AdminProductAdd() {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm({ defaultValues: { stockQuantity: 100 } });
  ...
  return (
    <div className="max-w-3xl space-y-8 animate-fadeIn text-gray-100">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-3xl font-extrabold text-white tracking-tight">New Catalog Entry</h1>
          <p className="text-gray-400 text-sm">Add a new item to the collection</p>
        </div>
      </div>
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-3xl p-8 shadow-lg">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              rows="4"
              placeholder="Provide a detailed description of the product highlights, features, and materials..."
